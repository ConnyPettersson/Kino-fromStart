async function fetchMovies() {
  const response = await fetch("https://raw.githubusercontent.com/ConnyPettersson/Kino-fromStart/main/movies.JSON");
...
function createMovie(movie) {
  ...
  return temp; // returnera det klonade DOM-elementet
}
